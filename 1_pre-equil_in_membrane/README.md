...
- Remove the nanobody if any (typically "resi 1000-*"), as well as ligands and crystallization agents ("organic"), waters ("resn HOH") and ions ("metal"). Removing the ligand will allow for waters come solvate the receptor properly at that stage.
