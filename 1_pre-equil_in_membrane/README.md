...
Note: If you need a new version or some help running it, ask Hugo Gutiérrez de Terán (PI of development team) or Jon Kapla who has been able to run it recently with an adaptation using the CHARMM force field (note that we will be using OPLS-AA here).
