...
LIGA=0
fout=open('mapping_ligpargen2Q.txt', 'w')
LIGA_coords={}
data={}
for line in pdbAin.readlines():
	if "ATOM" in line or "HETATM" in line:
		if "LIG" in line:
			LIGA=1
			atom_name=re.findall("[A-Z-a-z-0-9]+", line[12:17])[0]
			data[atom_name]="?"
...
fout.close()
print "Arlight, check mapping_ligpargen2Q.txt and remove the extra comma at the end of the dictionnary!"
